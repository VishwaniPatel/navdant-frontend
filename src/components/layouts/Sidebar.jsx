...
import navdant_logo from "../../../assets/images/logo/navdant_logo.png";
import name_logo from "../../../assets/images/logo/name_logo.png"
const menuItems = [
    {
        label: "Dashboard",
        path: "/",
...
function Sidebar({ sidebarOpen, setSidebarOpen }) {
    ...
    return (
      ...
      ========================================= */}
            ...
            <aside
                className={`fixed left-0 top-0 z-50 h-screen w-[260px] bg-primary transition-transform duration-300 lg:hidden ${sidebarOpen
                        ? "translate-x-0"
                        : "-translate-x-full"
                    }`}
            >
